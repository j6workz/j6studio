...
export const slots = [
  ...
  { id: "d1_arrive", day: 1, time_start: "07:00", time_end: "09:00",
    ...
    notes: "Land DMK, clear immigration, Grab to hotel ~250–400 THB / 30–45 min. Weather: 28°C feels 35, dry.",
    prev_slot_id: null },
  { id: "d1_checkin", day: 1, time_start: "09:00", time_end: "12:00",
    primary_id: "hotel", alt_ids: [],
    notes: "Drop bags, nap 3–4 hr (non-negotiable after redeye). Lobby lounge if room not ready. Weather: 32–34°C feels 37–39, UV 4–8.",
  ...
  { id: "d2_rest", day: 2, time_start: "14:30", time_end: "16:00",
    ...
    notes: "Energy call: shopping (Krungthong = plus-size AC, Chidlom + 8 min) OR hotel rest. Both storm-proof. Pick shopping if energy good, rest if Day 2 morning drained you. Weather: 31–32°C feels 38, drizzle 73–76%.",
  ...
  { id: "d3_breakfast", day: 3, time_start: "07:00", time_end: "08:00",
    primary_id: "hotel", alt_ids: [],
    notes: "Check out, store bags at front desk (free, ~6 hr). Big breakfast. Comfortable walking shoes. Weather: 26°C feels 33, dry, TStorm cells overhead.",
