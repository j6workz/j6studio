...
export const transports = [
  ...
  { key: "hotel→soi_nana_arab",
    primary: { steps: ["Walk Soi 5 → Sukhumvit Rd → Soi 3, ~5 min, 380 m"], duration_min: 5, cost_thb: 0 },
    storm_alt: null },
  { key: "soi_nana_arab→hotel",
    primary: { steps: ["Walk Soi 3 → Sukhumvit → Soi 5, ~5 min back"], duration_min: 5, cost_thb: 0 },
    storm_alt: null },
